...
sketchNeeded = quick_draw_data_set[random_number]; 
document.getElementById("neededSketch").innerHTML = "Sketch to be Drawn : " + sketchNeeded; 
timer_counter = 800; 
timer_check = " "; 
drawn_sketch = " "; 
answer_holder = " "; 
...
function checkSketch() {
    ...
    if(timer_counter < 0) {
        timer_counter = "Time's Up"; 
        // timer_check = "completed"
        div = "<button class = 'btn btn-warning' onclick = 'timerCompleted()'> Time's Up! Next Sketch! </button>"
        document.getElementById("neededSketch").innerHTML = div; 
    }
...
function gotResult(error, results) {
    if(error) {
        ...
        console.log(results); 
        document.getElementById("result").innerHTML = "Your Sketch : " + results[0].label; 
